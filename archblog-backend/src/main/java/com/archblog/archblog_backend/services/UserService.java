...
import com.archblog.archblog_backend.exceptions.DuplicateResourceException;
import com.archblog.archblog_backend.exceptions.InvalidOtpException;
...
public class UserService {
    ...
    public UserDTO register(UserDTO userDTO, String password) {
        if (userRepository.count() >= 200) {
            throw new LimitExceededException("Cannot register more than 200 users!");
        }
